export const post = {
  ...
  content: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "The Neuroscience Behind Making Decisions"
    },
    {
      type: "text",
      body: "When a child makes an autonomous decision, their brain activates the prefrontal cortex—the area responsible for judgment, planning, and impulse control. This exercise of 'own will' strengthens the neural connections that will define their leadership and self-management capacity in adult life. Stories, by presenting ethical and action dilemmas, force the child to perform mental simulations of these executive functions. Every time a child thinks 'I would do X' in the face of a character's problem, they are strengthening their neural musculature of autonomy."
    },
    {
      type: "highlight",
      variant: "info",
      title: "Key Catch",
      body: "Children who enjoy autonomy in their home environment (simple chores, choosing clothes, etc.) tend to show more advanced language development and a greater capacity for logical problem-solving."
    },
    {
      type: "heading",
      level: 2,
      text: "Stages of Autonomy Development"
    },
    {
      type: "text",
      body: "Autonomy doesn't arrive all at once; it is a constant evolution that adapts to the child's motor and cognitive abilities. It is fundamental that the stories we read are suited to these stages to avoid excessive frustration or boredom. A 3-year-old needs stories about daily routines where the protagonist achieves something physical, while a 9-year-old needs moral dilemmas where independence is played out in the realm of identity and personal values."
    },
    {
      type: "table",
      headers: ["Age Range", "Autonomy Milestone", "Story Theme"],
      rows: [
    ...
    {
      type: "story_table",
      headers: ["Skill", "Recommended Story", "Key Lesson"],
      rows: [
