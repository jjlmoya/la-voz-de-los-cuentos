export const post = {
  ...
  content: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Strategies to Foster Focus during Storytelling"
    },
    {
      type: "text",
      body: "Not all reading moments have the same impact on attention. To maximize concentration training, it is necessary to take care of certain aspects of the environment and interaction. Creating a reading sanctuary, a space free of screens and disruptive noises, is the first essential step. When the environment is quiet, the child's nervous system can relax, reducing their state of alertness and facilitating immersion in the imaginary world."
    },
    {
      type: "steps",
      items: [
        { title: "Environment Preparation", body: "Turn off electronic devices and find a comfortable place with soft lighting to reduce unnecessary external stimuli." },
        { title: "Bonding Establishment", body: "Ensure initial eye contact and physical proximity. Emotional safety is the best lubricant for learning." },
        { title: "Interactive Narration", body: "Make strategic pauses to invite the child to predict what will happen. This keeps their mind actively working on the plot." },
        { title: "Posterior Reflection", body: "Upon finishing, dedicate a few minutes to discuss the story. This helps consolidate memory and global understanding." }
      ]
    },
    {
      type: "heading",
      level: 3,
      text: "The importance of the tone of voice"
    },
    {
      type: "text",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Reading as an early Mindfulness exercise"
    },
    {
      type: "text",
      body: "Although we often associate mindfulness with formal meditation, shared storytelling is one of the most natural ways to practice mindfulness with children. Mindfulness means being present intentionally in what is happening. During the story, the child is immersed in a unique sensory and emotional experience. They are not thinking about what they will have for dinner or the toy they lost; they are present with the dragon, the rocket, or the forest rabbit. This state of flow or 'flow' is the culmination of concentration."
    },
    {
      type: "text",
      body: "Teaching a child to enter this state of literary immersion is giving them a mental refuge for life. In moments of future anxiety or stress, their brain will remember the ability to anchor itself in a meaningful activity and find calm through focus. Stories, therefore, not only train the brain for performance but also prepare it for emotional well-being. A child who knows how to concentrate is a child who has more tools to regulate their own nervous state through directed attention."
    },
    {
      type: "heading",
      level: 2,
      text: "Criteria for choosing stories that improve attention"
    },
    {
      type: "text",
      body: "Not all books serve this purpose in the same way. When choosing stories focused on concentration, we should look for those that have a coherent narrative rhythm but leave room for surprise. Stories with moderate suspense structures, where the outcome depends on clues that have been planted previously, are ideal because they reward the child who has been attentive throughout the story. Likewise, informative books on topics that fascinate the child (dinosaurs, space, insects) take advantage of their intrinsic motivation to extend their natural attention limits."
    },
    {
      type: "list",
      style: "unordered",
