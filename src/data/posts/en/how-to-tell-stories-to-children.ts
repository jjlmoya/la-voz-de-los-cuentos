export const post = {
  ...
  content: [
    {
      type: "text",
      body: "Telling stories to children is one of the most valuable gifts we can offer them. It's not just entertainment, but a powerful tool for their emotional, cognitive, and social development."
    },
    {
      type: "heading",
      level: 2,
    ...
    {
      type: "text",
      body: "Good narration requires preparation, attention, and love. Here are the best techniques to make your storytelling sessions unforgettable."
    },
    {
      type: "heading",
      level: 3,
      text: "1. Choose the Right Moment"
    },
    {
      type: "list",
      style: "unordered",
    ...
    },
    {
      type: "heading",
      level: 3,
      text: "2. Prepare Your Voice and Intonation"
    },
    {
      type: "list",
      style: "unordered",
    ...
    },
    {
      type: "heading",
      level: 3,
      text: "3. Create a Magical Atmosphere"
    },
    {
      type: "list",
      style: "unordered",
    ...
    },
    {
      type: "heading",
      level: 3,
      text: "4. Adapt to Age Group"
    },
    {
      type: "table",
      headers: ["Age", "Story Type", "Characteristics"],
      rows: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "5. The Power of Body Language"
    },
    {
      type: "text",
      body: "Storytelling extends far beyond the words you speak. Body language plays a fundamental role in conveying emotions and capturing children's attention. When you tell a story, your entire body becomes part of the narrative. Wide gestures, exaggerated facial expressions, and coordinated movements help children better understand the feelings behind each scene. For instance, when describing a frightened character, you might shrug your shoulders, widen your eyes in surprise, and lower your voice. These visual elements reinforce the narrative and make the experience more immersive and engaging for young listeners."
    },
    {
      type: "text",
      body: "Consider the importance of appropriate physical contact as well. A hug, holding hands, or simply sitting close during the story creates a sense of security and emotional connection. These moments of intimacy strengthen the bond between parent and child and transform storytelling into a meaningful shared experience. Children will remember not only the words of the story but also the warmth and closeness of being with someone they love while experiencing the adventure together."
    },
    {
      type: "heading",
      level: 2,
      text: "6. Adapting Classic Stories"
    },
    {
      type: "text",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "8. Proven Benefits of Bedtime Stories"
    },
    {
      type: "text",
