export const post = {
  ...
  tags: ["frustration", "perseverance", "emotional intelligence", "children's stories", "parenting"],
  content: [
    {
      type: "text",
      body: "Frustration is one of the most intense and frequent emotions in childhood, and also one of the most difficult to manage, both for children and for the adults who accompany them. It appears when there is a discrepancy between what the child wants and what they can get, or between their will and their technical ability to achieve a goal. However, far from being an obstacle to well-being, frustration is a 'master emotion' that, well managed, becomes the engine of perseverance and resilience. In this process of emotional learning, stories stand as the perfect laboratory where children can experience frustration safely and find models of overcoming."
    },
    {
      type: "text",
      body: "For a young child, the world is full of boundaries. Their body does not yet respond with the precision they would like, social norms often curb their impulses, and time does not pass at the speed of their desires. This lack of control generates a sense of injustice that often leads to tantrums or blockages. Stories offer a window to normalize this feeling. By reading about a character who also feels overwhelmed by circumstances, the child feels that their emotion is valid and shared, which reduces the burden of loneliness and guilt that sometimes accompanies frustration."
    },
    {
      type: "heading",
      level: 2,
      text: "Frustration as a Learning Opportunity"
    },
    {
      type: "text",
      body: "From a neuroeducational perspective, managing frustration is closely linked to the development of the prefrontal cortex and executive functions. When a child gets frustrated and manages to calm down to try again, they are strengthening self-regulation circuits. Stories act as a 'mental workout' for these circuits. Through narrative, the child observes the structure of a problem: the beginning (desire), the crisis (obstacle/frustration), and the resolution (effort/perseverance). This structure helps predict that even if the present moment is difficult, there is a way out."
    },
    {
      type: "stats",
      items: [
        { value: "70%", label: "Children who improve their persistence after working on emotional education" },
        { value: "4 min", label: "Recommended active waiting time to train patience in preschoolers" },
        { value: "85%", label: "Of daily childhood conflicts are born from low frustration tolerance" }
      ]
    },
    {
      type: "text",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "The Power of Characters Who Fail"
    },
    {
      type: "text",
    ...
    },
    {
      ...
      right: {
        title: "Healthy Management and Perseverance",
        items: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Transforming 'I Can't' into 'I Can't Yet'"
    },
    {
      type: "text",
