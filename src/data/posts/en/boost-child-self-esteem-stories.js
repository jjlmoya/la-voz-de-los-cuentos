export const post = {
  ...
  content: [
    ...
    },
    {
      ...
      slug: "find-my-that-lia’s-adventure-in-rainbow",
      description: "This story is the perfect tool for addressing low self-esteem because it accompanies Lia in the search for her own 'gift.' It helps children understand that we all have something that makes us special, even if it's not an obvious skill or a loud talent, teaching them that their value resides in their way of being and treating others.",
      variant: "primary",
      label: "Story to discover personal value"
    },
    {
      type: "heading",
      level: 2,
      text: "The Science of Narrative and Confidence"
    },
    {
      type: "text",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "7 Techniques with Stories to Train Security"
    },
    {
      type: "text",
      body: "Implementing these techniques does not require being an expert in psychology, only the will to connect through reading. Here are seven practical strategies to transform the story moment into a confidence training for your child:"
    },
    {
      type: "steps",
      items: [
        { title: "Identify Strengths in the Hero", body: "After reading, ask: 'What do you like most about this character?'. Then, make the bridge: 'Did you know you have that same bravery when you try to eat something new?'. By associating positive traits of the character with the child, you are setting positive labels on their identity." },
        { title: "The 'Alternative Ending' Game", body: "If a character does not achieve something, invent together how they could have tried it in another way. This fosters flexible thinking and reduces fear of blockage. It teaches that there is always a 'Plan B' and that our worth does not depend on Plan A working well the first time." },
        { title: "Reading Aloud with Characters", body: "Encourage your child to voice a self-confident character. By putting on the voice and posture of someone confident, the body sends security signals to the brain. It's an 'acting' technique that allows experiencing the physical sensation of confidence." },
        { title: "Error Detectives", body: "Look for stories where the protagonist messes up spectacularly. Celebrate the error as the beginning of the adventure. 'Good thing they were wrong, if not, they wouldn't have known the dragon!'. This deactivates toxic perfectionism." },
        { title: "The Magic Mirror of Stories", body: "After a story about talents, look for the 'mirror.' What things from the story look like our house? What things the character does can you do too? This helps land the fantasy in the child's daily reality." },
        { title: "Empowerment Pauses", body: "When the character doubts, stop reading and ask: 'What would you say to encourage them?'. What the child says to the character is, in reality, what they need to say to themselves. Listen carefully to those words: they are their own script of self-comfort." },
        { title: "Creation of Their Own Story", body: "Write or draw a story where the child is the protagonist overcoming something everyday (like tying shoelaces or going to the dentist). Seeing yourself as the hero of your own story is the most powerful self-esteem exercise there is." }
      ]
    },
    {
      type: "heading",
      level: 2,
      text: "Growth Mindset vs. Fixed Mindset"
    },
    {
      type: "text",
      body: "Psychologist Carol Dweck coined these terms that are fundamental for self-esteem. A child with a fixed mindset believes their capabilities are unalterable: 'I'm bad at math.' A child with a growth mindset believes their capabilities develop with effort: 'I don't know how to solve this yet.' Stories are the perfect vehicle to teach the 'not yet.' Overcoming stories show that talent is only the starting point, but persistence is what builds success. By reading about a character's development, the child understands that they too are under construction. It is not important where they are today, but where they are going and the desire they put into the path. Modern fairy tales don't tell us we're perfect, they tell us we can change and learn, which is the most empowering message a child can receive."
    },
    {
      type: "stats",
      items: [
        { value: "85%", label: "Of children who read about overcoming show greater resilience in the face of school failure" },
        { value: "15 min", label: "Of reading focused on values daily are enough to improve childhood self-concept" },
        { value: "3 of 4", label: "Child psychologists recommend bibliotherapy as fundamental support for self-esteem" }
      ]
    },
    {
      type: "heading",
      level: 2,
      text: "The Role of the Adult: Active Listening and Validation"
    },
    {
      type: "text",
      body: "No book can substitute the reflection the child sees in their parents' eyes. The story is the tool, but you are the craftsman. During the reading, maintain eye contact, nod to their reflections, and never minimize their doubts. If the child says 'I'm not brave like the knight,' don't tell them 'yes you are' automatically; ask them 'when have you felt that way?'. Giving space to vulnerability is the highest form of respect. True self-esteem is born from knowing we are loved even when we don't feel brave or smart. By sharing these stories, we are saying: 'I see you, I accept you, and I am here with you in your adventure of growing up.' That basic security is the foundation upon which all their future confidence will be built."
    },
    {
      type: "quote",
