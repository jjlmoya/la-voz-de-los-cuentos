export const post = {
  ...
  content: [
    ...
    },
    {
      ...
      right: {
        title: "Gestión Saludable y Perseverancia",
        items: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "La Empatía del Adulto ante el niño frustrado"
    },
    {
      type: "text",
      body: "A menudo, la frustración del niño dispara la frustración del adulto. Si ante una rabieta respondemos con gritos, estamos validando la pérdida de control. Los cuentos también nos sirven a los adultos para recordar la fragilidad del proceso infantil. Al leer juntos, estamos en un plano de igualdad, compartiendo un momento de calma que repara el vínculo tras un estallido emocional. El libro se convierte en un objeto mediador, una zona de paz donde ambos podemos reconectar y reflexionar sobre lo ocurrido durante el día sin reproches."
    },
    {
      type: "quote",
      text: "El éxito no es el final, el fracaso no es fatal: es el coraje de continuar lo que cuenta.",
      author: "Winston Churchill (Aplicado a la resiliencia infantil)"
    },
    {
      type: "heading",
      level: 2,
      text: "El Papel del Silencio en la Narración"
    },
    {
      type: "text",
