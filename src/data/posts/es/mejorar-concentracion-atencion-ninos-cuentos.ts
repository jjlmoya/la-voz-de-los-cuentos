export const post = {
  ...
  content: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Estrategias para Fomentar el Enfoque durante el Cuento"
    },
    {
      type: "text",
      body: "No todos los momentos de lectura tienen el mismo impacto en la atención. Para maximizar el entrenamiento de la concentración, es necesario cuidar ciertos aspectos del entorno y de la interacción. Crear un santuario de lectura, un espacio libre de pantallas y ruidos disruptivos, es el primer paso esencial. Cuando el ambiente es tranquilo, el sistema nervioso del niño puede relajarse, reduciendo su estado de alerta y facilitando la inmersión en el mundo imaginario."
    },
    {
      type: "steps",
      items: [
        { title: "Preparación del Entorno", body: "Apagar dispositivos electrónicos y buscar un lugar cómodo con iluminación suave para reducir estímulos externos innecesarios." },
        { title: "Establecimiento del Vínculo", body: "Asegurar contacto visual inicial y proximidad física. La seguridad emocional es el mejor lubricante para el aprendizaje." },
        { title: "Narración Interactiva", body: "Hacer pausas estratégicas para invitar al niño a predecir qué sucederá. Esto mantiene su mente trabajando activamente en la trama." },
        { title: "Reflexión Posterior", body: "Al terminar, dedicar unos minutos a comentar la historia. Esto ayuda a consolidar la memoria y la comprensión global." }
      ]
    },
    {
      type: "heading",
      level: 3,
      text: "La importancia del tono de voz"
    },
    {
      type: "text",
