export const post = {
  ...
  content: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "La Ciencia Detrás del Sueño y la Lectura"
    },
    {
      type: "text",
      body: "Diversos estudios de neurociencia han demostrado que la calidad del sueño mejora significativamente cuando se sustituyen las pantallas por libros físicos antes de dormir. La luz azul de los dispositivos electrónicos inhibe la secreción de melatonina, la hormona responsable de regular el sueño. Por el contrario, la luz cálida y la actividad analógica del libro permiten que el cerebro se prepare adecuadamente para el descanso nocturno."
    },
    {
      type: "stats",
      items: [
        { value: "35%", label: "Mejora en la calidad del sueño profundo" },
        { value: "25%", label: "Aumento del vocabulario en el primer año" },
        { value: "40%", label: "Reducción de pesadillas y despertares nocturnos" },
        { value: "50%", label: "Mejora en la capacidad de concentración escolar" }
      ]
    },
    {
      type: "highlight",
      variant: "tip",
      title: "Consejo de Experto para Narradores",
      body: "Intenta usar voces suaves y un ritmo de lectura pausado, casi musical. Esto ayuda a que el cerebro del niño cambie de las ondas beta (estado de alerta) a las ondas alfa (estado de relajación). No tengas miedo de exagerar un poco los sentimientos de los personajes; esto ayuda a la comprensión emocional."
    },
    {
      type: "heading",
      level: 2,
      text: "Cuentos en Papel vs. Pantallas Digitales"
    },
    {
      type: "text",
      body: "En la era digital, es tentador recurrir a tabletas o móviles para leer cuentos. Sin embargo, la ciencia es clara: el papel ofrece ventajas insustituibles para el desarrollo infantil y la higiene del sueño."
    },
    {
      type: "comparison",
      left: {
        title: "Cuentos Físicos (Papel)",
        items: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Cómo Elegir el Cuento Ideal para la Noche"
    },
    {
      type: "text",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Pasos para una Rutina de Lectura Perfecta"
    },
    {
      type: "steps",
      items: [
        { title: "Preparar el Ambiente", body: "Bajar la intensidad de las luces, asegurar una temperatura agradable y eliminar ruidos externos. El entorno debe susurrar que el día ha terminado." },
        { title: "Elegir Juntos", body: "Permitir que el niño elija el cuento de entre un par de opciones. Esto fomenta su autonomía, sentido de pertenencia y entusiasmo por la lectura." },
        { title: "Lectura Compartida", body: "Identificar un lugar cómodo. Leer con cercanía física, permitiendo pausas naturales para preguntas, reflexiones o simplemente para disfrutar de las ilustraciones." },
        { title: "Cierre Cálido e Íntimo", body: "Terminar con un mensaje positivo, un breve repaso de lo mejor del día y un abrazo cálido antes de apagar la luz definitivamente." }
      ]
    },
    {
      type: "heading",
      level: 2,
      text: "Preguntas Frecuentes de los Padres"
    },
    {
      type: "text",
      body: "¿A qué edad deberíamos empezar? La respuesta es: ¡desde el nacimiento! Incluso si no entienden las palabras, los bebés se benefician enormemente del ritmo de tu voz y de la cercanía física. Crea un hábito que crecerá con ellos."
    },
    {
      type: "text",
      body: "¿Qué pasa si siempre quiere el mismo cuento? Es totalmente normal y, de hecho, muy beneficioso. La repetición da seguridad al niño, le ayuda a dominar el lenguaje del cuento y a procesar profundamente su mensaje. Paciencia, es una etapa fundamental de su aprendizaje."
    },
    {
      type: "heading",
      level: 2,
      text: "La Lectura como Escudo contra las Pesadillas"
    },
    {
      type: "text",
      body: "Uno de los temores más comunes en la infancia son las pesadillas y el miedo a la oscuridad. La lectura nocturna actúa como un 'escudo psicológico'. Al llenar la mente del niño con imágenes positivas, resoluciones de conflictos y personajes valientes justo antes de dormir, estamos proporcionando el material con el que su subconsciente trabajará durante la noche. Un niño que se duerme pensando en las aventuras de un pequeño héroe tiene menos probabilidades de que su imaginación derive hacia miedos infundados."
    },
    {
      type: "text",
      body: "Además, el acto de leer implica un control consciente del pensamiento. A diferencia de ver una película, donde las imágenes son impuestas, al leer el niño debe construir la escena. Este ejercicio de control mental le otorga una sensación de dominio sobre su propio mundo interior, algo fundamental para combatir la ansiedad nocturna."
    },
    {
      type: "heading",
      level: 2,
      text: "El Impacto en la Inteligencia Emocional a Largo Plazo"
    },
    {
      type: "text",
      body: "La inteligencia emocional se define como la capacidad de reconocer, entender y gestionar nuestras propias emociones y las de los demás. Los cuentos son, en esencia, simuladores de vida. A través de ellos, los niños experimentan de forma segura la tristeza, la alegría, la frustración y la empatía. Al leer cada noche, estamos ofreciendo a nuestros hijos un laboratorio emocional continuo."
    },
    {
      type: "text",
      body: "Los estudios longitudinales sugieren que los niños que disfrutan de este tiempo compartido desarrollan una mayor resiliencia ante los problemas escolares y sociales. Aprenden que los problemas tienen solución y que las emociones negativas son una parte natural de la vida que se puede navegar con paciencia y apoyo."
    },
    {
      type: "heading",
      level: 2,
      text: "Cultivando un Hábito para Toda la Vida"
    },
    {
      type: "text",
